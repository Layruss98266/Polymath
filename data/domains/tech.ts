...
const d: Domain = {
 ...
 resources: {
  ...
  paid: [
   ...
   { name: "Clean Code, Robert C. Martin",          what: "Influential, opinionated; read with critique in mind.",          url: "",                                    price: "verify", weight: "popular", verify: false, lastVerified: "2026-06" },
