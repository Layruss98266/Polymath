...
const d: Domain = {
 ...
 basics: "Communication is the quiet work of getting an idea out of your head, accurately and durably, into someone else's. The hard part isn't being right. The hard part is being remembered.",
 deepBasics: "Most good ideas die not because they were wrong, but because they were too long, too abstract, told with no story, or buried somewhere on slide 47. Fix three things, structure, specifics, and stakes, and you'll suddenly notice your ideas getting picked up, agreed to, and repeated back to you by people who heard them once.",
 whyItMatters: [
 ...
 concepts: [
  ...
  },
  {
   ...
   expert: "Rosenberg (2003) draws on Rogerian client-centred therapy and Buddhist ethics. Distinct from active listening in providing a four-step expression structure rather than a reflection structure. The OFNR sequence (Observation, Feeling, Need, Request) is the formal acronym. Empirically used in mediation, education, and conflict zones (Rwanda, Israel-Palestine). Critiques: can feel formulaic if recited mechanically, can mask genuine power asymmetries by treating both sides as symmetric, and conflates needs with wants in some applications. Empirical base is thin; most evidence is qualitative case work rather than RCTs.",
   status: "debated",
