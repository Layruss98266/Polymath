...
const d: Domain = {
  ...
  resources: {
    free: [
      { name: "On Writing Well — William Zinsser (library)", what: "The non-fiction writing classic. Short and direct.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "Paul Graham's essays", what: "Master class in clear, confident essay writing.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "TED Talks — a curated list of the best", what: "Watch with structure in mind. Notice the openings.", url: "", verify: true, lastVerified: "2026-06" }
    ],
    paid: [
      { name: "Made to Stick — Chip & Dan Heath", what: "Why some ideas survive (SUCCESs framework).", url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "Resonate — Nancy Duarte", what: "Structure for talks and decks.", url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "The Pyramid Principle — Barbara Minto", what: "Top-down structured writing. McKinsey gospel.", url: "", price: "verify", verify: true, lastVerified: "2026-06" }
    ]
  },
