...
const d: Domain = {
 ...
 resources: {
  ...
  paid: [
   ...
   { name: "Talk Like TED, Carmine Gallo",            what: "What works in the best TED talks, structured.",                      url: "",                                  price: "verify", verify: false, lastVerified: "2026-06" },
   { name: "Bird by Bird, Anne Lamott",             what: "Writing as life-practice; humane and useful.",                      url: "",                                  price: "verify", verify: false, lastVerified: "2026-06" },
