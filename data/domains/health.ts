...
const d: Domain = {
  ...
  resources: {
    free: [
      { name: "Peter Attia — The Drive podcast (free episodes)", what: "Long-form, technical, but accessible. Best general longevity-medicine intro.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "WHO — physical activity & sleep guidelines", what: "Official, free, conservative — solid baseline.", url: "", verify: true, lastVerified: "2026-06" },
    ...
    paid: [
      { name: "Outlive — Peter Attia", what: "The four horsemen + the healthspan playbook.", url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "Why Zebras Don't Get Ulcers — Robert Sapolsky", what: "Stress biology, beautifully written.", url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "Being Mortal — Atul Gawande", what: "How medicine actually treats aging + dying — and what it gets wrong.", url: "", price: "verify", verify: true, lastVerified: "2026-06" }
    ]
  },
