...
const d: Domain = {
  ...
  resources: {
    free: [
      { name: "Morgan Housel — Collab Fund blog archive",                                what: "Short, behavioural-finance essays from the Psychology of Money author.",                                  url: "", verify: true, lastVerified: "2026-06" },
      { name: "Zerodha Varsity (free, India-specific)",                                   what: "Genuinely good, free course on Indian markets, taxes, mutual funds, insurance.",                          url: "", verify: true, lastVerified: "2026-06" },
      { name: "RBI — Financial Education portal",                                         what: "Official, India-specific — banking, lending, scams, regulation.",                                          url: "", verify: true, lastVerified: "2026-06" },
      { name: "SEBI Investor Awareness materials",                                        what: "Regulator's own investor-education PDFs — bias-free baseline.",                                              url: "", verify: true, lastVerified: "2026-06" },
      { name: "JL Collins — Stock Series (blog)",                                          what: "The classic plain-English case for index-fund investing. US-flavoured but the math is universal.",         url: "", verify: true, lastVerified: "2026-06" }
    ],
    paid: [
      { name: "The Psychology of Money — Morgan Housel",                                  what: "Why behaviour beats spreadsheets. The single best general personal-finance read.",                            url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "I Will Teach You to Be Rich — Ramit Sethi",                                what: "Actionable system for automating money, paired with permission to spend on what you love.",                  url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "The Simple Path to Wealth — JL Collins",                                   what: "Father-to-daughter letters explaining the low-cost index path.",                                                url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "Let's Talk Money — Monika Halan",                                          what: "India-specific personal finance fundamentals from a respected author/regulator-adjacent voice.",              url: "", price: "verify", verify: true, lastVerified: "2026-06" }
    ]
  },
