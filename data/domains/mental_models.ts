...
const d: Domain = {
 ...
 resources: {
  ...
  paid: [
   ...
   { name: "Seeking Wisdom, Peter Bevelin",          what: "Mental-models book that distils Munger and Buffett.",              url: "",                                           price: "verify", verify: false, lastVerified: "2026-06" },
   ...
   { name: "Skin in the Game, Nassim Taleb",          what: "Asymmetric risk + ethics. Read with critique in mind.",             url: "",                                           price: "verify", verify: false, lastVerified: "2026-06" },
