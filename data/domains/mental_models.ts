...
const d: Domain = {
  ...
  resources: {
    free: [
      { name: "Farnam Street blog (fs.blog)", what: "Free archive of mental-model essays and book breakdowns.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "Charlie Munger USC commencement (\"The Psychology of Human Misjudgement\")", what: "Free speech/transcript. The original popular case for the latticework.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "Donella Meadows — \"Leverage Points\" (essay)", what: "Free, short, foundational systems-thinking essay.", url: "", verify: true, lastVerified: "2026-06" }
    ],
    paid: [
      { name: "The Great Mental Models (Vol 1–4) — Shane Parrish", what: "Most accessible curated set.", url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "Thinking in Systems — Donella Meadows", what: "Systems thinking made teachable.", url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "Antifragile — Nassim Taleb", what: "Spiky, useful, sometimes wrong, always provocative.", url: "", price: "verify", verify: true, lastVerified: "2026-06" }
    ]
  },
