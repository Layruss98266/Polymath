...
const d: Domain = {
 ...
 resources: {
  ...
  paid: [
   ...
   { name: "Pattern Recognition and Machine Learning, Bishop",        what: "Classical ML, Bayesian-flavoured. Graduate level.",                               url: "",                                                   price: "verify", verify: false, lastVerified: "2026-06" },
