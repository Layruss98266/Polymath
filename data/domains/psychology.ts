...
const d: Domain = {
 ...
 resources: {
  ...
  paid: [
   ...
   { name: "Pre-Suasion, Cialdini",             what: "What happens before the ask. Companion to Influence.",          url: "https://www.influenceatwork.com/",                        price: "verify", weight: "secondary", verify: true, lastVerified: "2026-06" },
   { name: "Behave, Robert Sapolsky",            what: "Why we do what we do, from synapses to societies.",           url: "https://www.penguinrandomhouse.com/books/314463/behave-by-robert-m-sapolsky/",  price: "verify", weight: "primary", verify: true, lastVerified: "2026-06" },
