...
const d: Domain = {
 ...
 basics: "Most of what you think of as \"deciding\" already happened before you noticed. Some part of your brain handled it in a tenth of a second, and the part of you that talks to itself in words showed up afterwards to take credit.",
 deepBasics: "Psychology is the careful study of this gap, between what we actually do and the stories we tell about why we did it. You can't think your way out of having biases. You can learn to spot them, especially the ones that are quietly costing you money, relationships, or sleep.",
 whyItMatters: [
 ...
 diagrams: [
  ...
  { kind: "cycle", title: "Habit loop (Clear, 2018; extends Duhigg, 2012)", caption: "James Clear's 4-step model (cue, craving, response, reward) builds on Duhigg's 3-step cue, routine, reward. The 4-step is shown here.", data: { nodes: ["Cue", "Craving", "Response", "Reward"] } }
 ],
 ...
 concepts: [
  ...
  },
  {
   ...
   deep: "John Darley and Bibb Latane began studying this after the 1964 Kitty Genovese murder, where early reporting claimed thirty eight witnesses did nothing. The reporting was later reframed by Manning, Levine, and Collins (2007, American Psychologist), who showed the original 38-witnesses framing was inaccurate, but the underlying phenomenon held up in laboratory work. In their 1968 smoke filled room study, a person alone reported smoke quickly, while a person with two passive confederates often sat through it without acting. Two mechanisms drive it: diffusion of responsibility, where each person assumes someone else will act, and pluralistic ignorance, where each looks at the calm faces of others and concludes the situation is not serious. The practical antidote is to single someone out: point at a specific person and tell them what to do, which collapses the diffusion.",
  ...
  },
  {
   ...
   expert: "Csikszentmihalyi (1975, 1990) operationalised flow through the experience sampling method and the challenge skill balance model. Updated channel models, like Massimini and Carli's eight channel framework, refine the original three by including apathy and arousal regions. Dietrich (2003, Consciousness and Cognition) proposed transient hypofrontality, a temporary downregulation of the prefrontal cortex, as a candidate mechanism, though this remains debated. Engagement-at-work studies by Bakker (2008) confirm flow predicts performance and wellbeing.",
   status: "framework",
  ...
  },
  {
   ...
   expert: "Baumeister, Bratslavski, Finkenauer, and Vohs (2001) and Rozin and Royzman (2001) summarised the phenomenon across domains. Marriage research by Gottman estimates roughly a five to one positive to negative interaction ratio during conflict episodes. The precise ratio has been contested by Heyman and Slep and others; it applies to conflict interactions, not all interactions. Neurally, amygdala and anterior cingulate respond more strongly and rapidly to negative stimuli. Cacioppo's evaluative space model formalises positivity and negativity as separable rather than opposite dimensions.",
   status: "settled",
