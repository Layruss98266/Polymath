...
const d: Domain = {
  ...
  resources: {
    free: [
      { name: "Seth Godin's blog",                                 what: "Daily, short, original takes on marketing fundamentals and ethics.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "Made to Stick — Chip & Dan Heath (library / used)", what: "Why some ideas survive and others die. The SUCCESs framework.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "Ogilvy on Advertising — David Ogilvy (library)",    what: "Old, opinionated, still works on copy fundamentals.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "Marketing Examples (case-study site)",              what: "Bite-sized real campaigns explained — great pattern-library.", url: "", verify: true, lastVerified: "2026-06" }
    ],
    paid: [
      { name: "Positioning — Al Ries & Jack Trout",                what: "The original classic. Short and dense.",                                                  url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "How Brands Grow — Byron Sharp",                     what: "The evidence-based steelman against pure positioning theory.",                            url: "", price: "verify", verify: true, lastVerified: "2026-06" },
