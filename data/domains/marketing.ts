...
const d: Domain = {
 ...
 basics:
  "Imagine you run a small bakery. Your bread is genuinely better than the supermarket's, but nobody walks past your door. Marketing is the work you do so the right people walk past, notice, try, and come back.",
 deepBasics:
  "That's it. It isn't ads. It isn't tricking anyone. It's the bridge between something useful and the person who'd be glad they found it. Get good at marketing and the bakery thrives. Get bad at it and you make great bread for an empty room.",
 whyItMatters: [
 ...
 concepts: [
  ...
  { t: "Social proof",                subdomain: "behaviour", short: "We copy people who look like us, especially when we're unsure.",                                      deep: "Standing outside two restaurants, both new, one empty and one half full, which do you walk into? Half full. Every time. That instinct is social proof. It shows up in testimonials, reviews, \"used by 50,000 teams,\" the queue outside the new café. The trick: it has to come from people your buyer recognises themselves in. A glowing quote from a CEO won't help a teenager pick sneakers; a glowing TikTok from someone their age will. Fake reviews work for a quarter, then poison you for years.", generic: "Two new shops on the same street, one empty and one with a small queue. You walk into the busy one without thinking about it. That instinct, copying people who look a bit like you when you are unsure, is social proof. It is why reviews, testimonials, and visible queues nudge strangers to act.", expert: "Magnitude varies widely across contexts; large-scale RCT replications of social-norm nudges (DellaVigna and Linos, 2022, in government settings) report near-zero effects in many conditions.", status: "settled",  reflect: "Look at your most visible social proof. Are those people the target audience would identify with, or just the most impressive you could find?" },
