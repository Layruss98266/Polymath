...
const d: Domain = {
 ...
 concepts: [
  ...
  { t: "Social proof",                subdomain: "behaviour", short: "We copy people who look like us, especially when we're unsure.",                                      deep: "Standing outside two restaurants, both new, one empty and one half full, which do you walk into? Half full. Every time. That instinct is social proof. It shows up in testimonials, reviews, \"used by 50,000 teams,\" the queue outside the new café. The trick: it has to come from people your buyer recognises themselves in. A glowing quote from a CEO won't help a teenager pick sneakers; a glowing TikTok from someone their age will. Fake reviews work for a quarter, then poison you for years.",                                                                                                                                     expert: "Magnitude varies widely across contexts; large-scale RCT replications of social-norm nudges (DellaVigna and Linos, 2022, in government settings) report near-zero effects in many conditions.", status: "settled",  reflect: "Look at your most visible social proof. Are those people the target audience would identify with, or just the most impressive you could find?" },
