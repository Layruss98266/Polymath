...
const d: Domain = {
  ...
  resources: {
    free: [
      { name: "Veritasium (YouTube)", what: "Best general-audience physics + science explainers.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "PBS Spacetime (YouTube)", what: "Modern physics, intuition-first.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "Feynman Lectures (free online)", what: "The original masterclass, free.", url: "", verify: true, lastVerified: "2026-06" }
    ],
    paid: [
      { name: "Six Easy Pieces — Richard Feynman", what: "Selected chapters from the Lectures. Excellent first read.", url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "The Order of Time — Carlo Rovelli", what: "Beautifully written physics-as-philosophy.", url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      { name: "On the Origin of Species — Darwin", what: "Still the clearest exposition of the idea.", url: "", price: "verify", verify: true, lastVerified: "2026-06" }
    ]
  },
