...
const d: Domain = {
  ...
  resources: {
    free: [
      { name: "India Code (government legal portal)", what: "Free, official text of central + state laws.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "PRS Legislative Research", what: "Free, non-partisan explainers on Indian bills + laws.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "SCO India (Supreme Court Observer)", what: "Accessible reporting on Indian constitutional cases.", url: "", verify: true, lastVerified: "2026-06" },
      { name: "FindLaw / Cornell LII (US)", what: "Free legal reference if you're in or studying the US system.", url: "", verify: true, lastVerified: "2026-06" }
    ],
    paid: [
      { name: "The Concept of Law — H.L.A. Hart", what: "Foundational jurisprudence book. Dense but rewarding.", url: "", price: "verify", verify: true, lastVerified: "2026-06" },
      ...
      { name: "Nudge — Thaler & Sunstein", what: "Behavioural law/economics — choice architecture meets policy.", url: "", price: "verify", verify: true, lastVerified: "2026-06" }
    ]
  },
