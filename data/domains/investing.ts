...
const d: Domain = {
 ...
 resources: {
  ...
  paid: [
   ...
   { name: "The Most Important Thing, Howard Marks",     what: "Cycles, risk, second-level thinking.",                url: "https://www.oaktreecapital.com/",                            price: "verify", weight: "secondary", verify: true, lastVerified: "2026-06" },
   ...
   { name: "One Up On Wall Street, Peter Lynch",       what: "Bottom-up stock picking, accessibly written.",            url: "",                                           price: "verify", verify: false, lastVerified: "2026-06" },
   { name: "The Little Book of Common Sense Investing, Bogle", what: "Compact version of Bogle's index-investing case.",         url: "",                                           price: "verify", weight: "secondary", verify: false, lastVerified: "2026-06" },
   ...
   { name: "Coffee Can Investing, Saurabh Mukherjea",    what: "India-specific buy-and-hold-quality framework.",           url: "",                                           price: "verify", verify: false, lastVerified: "2026-06" },
   { name: "Margin of Safety, Seth Klarman (out of print)", what: "Hard-to-find classic; library access if you can.",          url: "",                                           price: "verify", verify: false, lastVerified: "2026-06" },
